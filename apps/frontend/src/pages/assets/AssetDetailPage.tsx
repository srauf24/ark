        ...
        return (
            <div className="space-y-4">
                ...
                <Alert variant="destructive">
                    ...
                    <AlertDescription>
                        Failed to load asset details. The asset may not exist or you don't have permission to view it.
                    </AlertDescription>
                </Alert>
            </div>
        );
            ...
            <Card className="opacity-60">
                ...
                <CardContent>
                    <div className="flex h-32 items-center justify-center rounded-md border border-dashed">
                        <p className="text-sm text-muted-foreground">Log history will be available soon</p>
                    </div>
                </CardContent>
            </Card>
        </div>
